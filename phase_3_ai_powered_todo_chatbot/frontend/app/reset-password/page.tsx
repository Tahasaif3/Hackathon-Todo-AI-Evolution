...
import { ListTodo, Key, Shield, Zap } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#020617] py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden selection:bg-indigo-500/30">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-[-20%] left-[-10%] w-[60%] h-[60%] bg-purple-600/10 blur-[150px] rounded-full animate-pulse" style={{ animationDelay: '2s' }} />
        ...
        <div className="text-center mb-12">
          ...
          >
            <h1 className="text-5xl font-black text-white tracking-tighter mb-4 uppercase">
              Cipher <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400">Override</span>
            </h1>
            <p className="text-slate-400 font-medium text-lg opacity-60 tracking-tight">Define a new access key for your identity.</p>
          </motion.div>
        </div>
