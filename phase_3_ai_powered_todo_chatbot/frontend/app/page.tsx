...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-white/90 backdrop-blur-lg shadow-sm" : "bg-white"
          }`}
      >
            ...
            <div className="flex items-center gap-3">
              {isLoggedIn ? (
                <button
                  ...
                  className="text-sm px-6 py-2 bg-gradient-to-r from-indigo-600 to-indigo-800 text-white rounded-full font-medium hover:from-indigo-700 hover:to-indigo-900 transition-all duration-300 shadow-md hover:shadow-lg flex items-center gap-2"
                >
                  Dashboard
                </button>
              ) : (
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
              <div className={`flex-1 max-w-xl transition-all duration-1000 ${heroInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                ...
                <h1 className={`text-5xl md:text-6xl font-bold mb-6 leading-tight transition-all duration-700 delay-150 ${heroInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                  Boost Your Productivity With Task-Flow
                </h1>
                ...
                <div className={`flex gap-4 transition-all duration-700 delay-500 ${heroInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                  <button
                    onClick={() => router.push(isLoggedIn ? '/tasks' : '/register')}
